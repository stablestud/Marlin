...
#define STRING_CONFIG_H_AUTHOR "stablestud" // Who made the changes.
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 134.72
  #define DEFAULT_bedKi 26.31
  #define DEFAULT_bedKd 459.86
...
//
#define PREHEAT_1_LABEL       "COLDPULL"
#define PREHEAT_1_TEMP_HOTEND  85
